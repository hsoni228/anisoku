...
try
 {
   ...
   String sql="SELECT level FROM score WHERE user='"+user+"'";
    ...
    String site ="http://192.241.177.72:8080/ANISOKUultimate/congrats_the_end.html";
               response.setStatus(response.SC_MOVED_TEMPORARILY);
        response.setHeader("Location", site); 
     //out.println("\nGood Job");
    //out.println(pow);
...
<center><b><h1 style="font-size:80;font-family:Twelve Ton Sushi;">ANISOKU<br>Level 35</h1></b></center>
<xyz><img src="level 35.jpg" border="5" width=500px height=300px></xyz>
